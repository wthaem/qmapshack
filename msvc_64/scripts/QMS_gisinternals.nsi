...
; "C:\Program Files (x86)\NSIS\makensis.exe" /V4 /INPUTCHARSET UTF8 QMS_gisinternals.nsi
...
;Include Modern UI
  ...
  !include "QMS_gisinternals_add.nsi"
...
;General
  ...
  VIAddVersionKey  "LegalCopyright" "Copyright (©) 2026, Oliver Eichler"
