...
rem echo %2\build_%1_add.bat

call %2\build_%1_add.bat
...
cmake --fresh -G "Visual Studio 17 2022" -A x64 -S .. -B . -LA -DPKG=%1 -DQMSUSERCFG=%usercfg% -DCMAKE_CXX_FLAGS="/EHsc" -DUPDATE_TRANSLATIONS=OFF -C  %scriptsdir%\CfgGisinternals.cfg
