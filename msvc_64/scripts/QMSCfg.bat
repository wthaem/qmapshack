...
cmake --fresh -G "Visual Studio 17 2022" -A x64 -S .. -B . -LA -DPKG=%1 -DQMSUSERCFG=%usercfg% -DCMAKE_CXX_FLAGS="/EHsc" -DUPDATE_TRANSLATIONS=ON -C  %scriptsdir%\CfgGisinternals.cfg
