...
BLOCK "StringFileInfo"
{
	...
	{
		VALUE "CompanyName", ""
		VALUE "FileDescription", QMS_UP+" (Compiled with GISInternals. Used commit: bed5c40 of fork/branch: kiozen/dev.)"
		...
		VALUE "Comments", "Compiled with GISInternals. Used commit: bed5c40 of fork/branch: kiozen/dev"
		VALUE "SpecialBuild", "Compiled with GISInternals. Used commit: bed5c40 of fork/branch: kiozen/dev"
	}
}
BLOCK "VarFileInfo"
{
