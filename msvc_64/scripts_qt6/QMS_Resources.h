...
BLOCK "StringFileInfo"
{
	...
	{
		VALUE "CompanyName", ""
		VALUE "FileDescription", QMS_UP+" (Compiled with GISInternals. Used commit: 0e8f619 of fork/branch: maproom/dev.)"
		...
		VALUE "Comments", "Compiled with GISInternals. Used commit: 0e8f619 of fork/branch: maproom/dev"
		VALUE "SpecialBuild", "Compiled with GISInternals. Used commit: 0e8f619 of fork/branch: maproom/dev"
	}
}
BLOCK "VarFileInfo"
{
