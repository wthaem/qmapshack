...
BLOCK "StringFileInfo"
{
	...
	{
		VALUE "CompanyName", ""
		VALUE "FileDescription", QMS_UP+" (Compiled with GISInternals. Used commit: 0e2a3d5 of fork/branch: wthaem/dev_build.)"
		...
		VALUE "Comments", "Compiled with GISInternals. Used commit: 0e2a3d5 of fork/branch: wthaem/dev_build"
		VALUE "SpecialBuild", "Compiled with GISInternals. Used commit: 0e2a3d5 of fork/branch: wthaem/dev_build"
	}
}
BLOCK "VarFileInfo"
{
