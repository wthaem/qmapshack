...
BLOCK "StringFileInfo"
{
	...
	{
		VALUE "CompanyName", ""
		VALUE "FileDescription", QMS_UP+" (Compiled with GISInternals. Used commit: 6ddf240 of fork/branch: maproom/dev.)"
		...
		VALUE "Comments", "Compiled with GISInternals. Used commit: 6ddf240 of fork/branch: maproom/dev"
		VALUE "SpecialBuild", "Compiled with GISInternals. Used commit: 6ddf240 of fork/branch: maproom/dev"
	}
}
BLOCK "VarFileInfo"
{
