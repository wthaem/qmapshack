...
set QMSI_GIS_PATH=d:\QtProjects\QMS\gisinternals\1930_241023\release-1930-x64
set QMSI_QT_PATH="d:\Qt\5.12.3\6.8.0\msvc2022_64"
set QMSI_VCREDIST_PATH="C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Redist\MSVC\14.40.33807\"
set QMSI_ROUT_PATH="d:\QtProjects\QMS\routino\routino-3.4.1\install"
...
copy  %QMSI_GIS_PATH%\bin\proj_9_3.dll
...
xcopy %QMSI_QMS_PATH%\mysql\sqldrivers\qsqlmysql*.dll sqldrivers /i
mkdir share\proj
